#!/usr/bin/env python3
"""
Test the Personalization & ML Model Service
"""
...
async def create_test_data(db: AsyncSession):
    """Create test data with interactions for personalization testing"""
    print("📝 Creating test data with interactions...")
    
    # Create test candidates
    candidates = []
    
    # Candidate 1: Python developer with high engagement
    ...
    # Candidate 2: Data scientist with different preferences
    ...
    # Candidate 1 interactions (Python developer)
    interactions1 = [
        # Views and applies to Python jobs
        ...
        # Views but doesn't apply to data science jobs
    ...
    # Candidate 2 interactions (Data scientist)
    interactions2 = [
        # Views and applies to data science jobs
        ...
        # Views but doesn't apply to Python development jobs
...
async def test_ml_trainer_service():
    ...
    try:
        ...
        mock_interactions = [{"job_id": 1, "interaction_type": "View", "timestamp": datetime.utcnow()}]
        mock_user_patterns = {
...
async def test_personalization_service():
    ...
    async for db in get_db_session():
        try:
            # Get test data
            candidates, jobs = await create_test_data(db)
...
async def main():
    ...
    print("🚀 Testing Personalization & ML Model Service")
    print("=" * 60)
